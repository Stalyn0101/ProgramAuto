...
public class Autom {
    ...
    public Autom (String Marca, int Modelo, double Motor, TipoCombus tipoCombus, TipoAuto tipoAuto, int numAsientos, int numPuertas, double velocMaxima, Color color, double velocActual) {
        this.Marca = Marca;
        this.Modelo = Modelo;
        this.Motor = Motor;
